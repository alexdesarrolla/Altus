...
<head>
    ...
    <title>Insurax - Insurance Company HTML Template - Blog Details</title>
                    ...
                    <div class="th-blog blog-single">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                ...
                                <a href="blog.html"><i class="fa-light fa-calendar-days"></i>12 June, 2023</a>
                            ...
                            <p>Proin dictum accumsan ante, vel cursus nulla congue quis. Aliquam a nisi pretium, facilisis arcu quis, placerat massa. Praesent ac odio quis massa commodo iaculis et at turpis. Aliquam ligula urna, lacinia eget egestas in, egestas nec ex. Donec finibus nulla in odio aliquet lacinia. Aenean vel tortor malesuada, elementum urna sit amet, pharetra elit. Nullam sed leo nec est eleifend accumsan. Donec rhoncus sem diam, eget euismod sapien tempor eu. Nunc venenatis justo id finibus condimentum.
                            </p>
                            <p>Quisque vel auctor ex, et ullamcorper orci. Cras consequat consequat tincidunt. Sed placerat faucibus velit imperdiet ultricies. Etiam lobortis enim quis justo viverra, sed sagittis diam semper. Etiam rutrum volutpat tellus, non viverra justo vulputate vitae. Nunc quis libero a nisi elementum condimentum dapibus vel nisi. Ut varius vestibulum mauris, ac viverra velit scelerisque eget. </p>
                            <blockquote>
                                <p>Proin dictum accumsan ante, vel cursus nulla congue quis. Aliquam a nisi pretium, facilisis arcu quis, placerat massa. Praesent ac odio quis massa commodo iaculis et at turpis. </p>
                            ...
                            <p class="mb-0">Vivamus sit amet efficitur mauris. Ut vehicula venenatis arcu id venenatis. Nam ac rutrum risus, nec vulputate arcu. Donec suscipit tellus eu lorem bibendum, eu maximus orci feugiat. Donec pulvinar vulputate finibus. Praesent tempor risus et gravida molestie. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Lorem ipsum dolor sit amet</p>
                        </div>
                        <div class="share-links clearfix ">
                            <div class="row justify-content-between align-items-end">
                                <div class="col-sm-auto">
                                    <div class="share-links-title">Related Tags :</div>
                                    <div class="tagcloud">
                            ...
                            <ul class="project-details-nav">
                                <li>
                                    <a href="#">
                                        <span class="thumb"><span class="icon"><i class="far fa-arrow-left"></i></span><img src="assets/img/project/project_details6.png" alt="img"></span>
                                        <span class="text d-xl-block d-none">Family Insurance</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="project-details-bar-icon" href="#">
                                        <i class="fa-light fa-grid-2"></i>
                                    </a>
                                </li>
                                <li class="next-project-nav">
                                    <a href="#">
                                        <span class="text d-xl-block d-none">Business Insurance</span>
                                        <span class="thumb"><img src="assets/img/project/project_details7.png" alt="img"><span class="icon"><i class="far fa-arrow-right"></i></span></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="th-comments-wrap ">
                            <h2 class="blog-inner-title h4"> 03 Comments</h2>
                            <ul class="comment-list">
                                <li class="th-comment-item">
                                    <div class="th-post-comment">
                                        ...
                                        <div class="comment-content">
                                            <div class="d-flex">
                                                <h3 class="name">Guy Hawkins</h3>
                                                <span class="commented-on"><i class="fal fa-calendar-alt"></i>14 March, 2023</span>
                                            </div>
                                            <p class="text">Their representatives are knowledgeable and friendly, and they were able to help me find the perfect policy to fit my needs. Highly recommended!</p>
                                        ...
                                        <li class="th-comment-item">
                                            <div class="th-post-comment">
                                                ...
                                                <div class="comment-content">
                                                    ...
                                                    <p class="text"> However, this company made the process so easy and stress-free. Their claims adjusters were helpful and efficient, and they were able to get me back on the road in no time.</p>
                                                    <div class="reply_and_edit">
                                                        <a href="blog-details.html" class="reply-btn"><i class="fas fa-reply"></i>Reply</a>
                                                    </div>
                                                </div>
                                ...
                                <li class="th-comment-item">
                                    <div class="th-post-comment">
                                        ...
                                        <div class="comment-content">
                                            <div class="d-flex">
                                                <h3 class="name">Floyd Miles</h3>
                                                <span class="commented-on"><i class="fal fa-calendar-alt"></i>06 June, 2023</span>
                                            </div>
                                            <p class="text">Their claims team was professional and helpful, and they made the process so easy. I am so grateful for their assistance during a difficult time.</p>
                                            <div class="reply_and_edit">
                                                <a href="blog-details.html" class="reply-btn"><i class="fas fa-reply"></i>Reply</a>
                                            </div>
                                        </div>
                        ...
                        <div class="th-comment-form ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 form-group mb-0">
                                    <button class="th-btn">Read More <i class="far fa-arrow-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
