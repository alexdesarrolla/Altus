...
<head>
    ...
    <title>Insurax - Insurance Company HTML Template - Home One</title>
...
==============================-->
    <footer class="footer-wrapper footer-layout1" data-bg-src="assets/img/bg/footer_bg_1.png">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="widget newsletter-widget footer-widget">
                            <h3 class="widget_title">Get Update</h3>
                            <p class="footer-text">Sign up for our latest news & articles. We won’t give you spam mails.</p>
                            <form class="newsletter-form">
                                <input class="form-control" type="email" placeholder="Enter Email" required="">
                                <button type="submit" class="th-btn"><i class="fa fa-paper-plane"></i></button>
                            </form>
        ...
        <div class="copyright-wrap">
            <div class="container">
                <p class="copyright-text text-center"><i class="fal fa-copyright"></i> 2023 All Rights Reserved By <a href="#">Insurax.</a></p>
            </div>
        </div>
    </footer>
