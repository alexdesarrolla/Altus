                                ...
                                <div class="col-auto">
                                    <div class="header-links">
                                        <ul>
                                            ...
                                            <li><i class="fal fa-envelope"></i><a href="mailto:info@insurax.com">info@insurax.com</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-auto">
...
==============================-->
    <div class="th-hero-wrapper hero-slider-8 th-carousel" data-slide-show="1" data-md-slide-show="1" data-fade="true" data-dots="true" data-xl-dots="true" data-ml-dots="true" data-lg-dots="true" id="hero">
        ...
        <div class="th-hero-slide">
            <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_bg_6_1.jpg">
                <img src="assets/img/update1/hero/hero_overlay_7.png" alt="Hero Image">
            </div>
            <div class="container">
                <div class="hero-style8">
                    <span class="hero-subtitle" data-ani="slideindown" data-ani-delay="0.7s">Insurance Destination Here</span>
                    <h1 class="hero-title" data-ani="slideindown" data-ani-delay="0.4s">Secure Your Future</h1>
                    <h1 class="hero-title" data-ani="slideindown" data-ani-delay="0.1s">Shielding Your Risks</h1>
                    <p class="hero-text" data-ani="slideinup" data-ani-delay="0.1s">Securing your family's financial future is a priority. Our range of life insurance options provides you with choices to protect your loved.</p>
                    <div class="btn-group" data-ani="slideinup" data-ani-delay="0.5s">
                        <a href="about.html" class="th-btn style3">Learn More<i class="fas fa-long-arrow-right ms-2"></i></a>
                        <a href="contact.html" class="th-btn style6">Get A Quote<i class="fas fa-long-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="th-hero-slide">
            <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_bg_6_2.jpg">
                <img src="assets/img/update1/hero/hero_overlay_7.png" alt="Hero Image">
            </div>
            <div class="container">
                <div class="hero-style8">
                    <span class="hero-subtitle" data-ani="slideindown" data-ani-delay="0.7s">Safeguarding Your Tomorrow</span>
                    <h1 class="hero-title" data-ani="slideindown" data-ani-delay="0.4s">Insurance Solution</h1>
        ...
        <div class="th-hero-slide">
            <div class="th-hero-bg" data-bg-src="assets/img/hero/hero_bg_6_3.jpg">
                <img src="assets/img/update1/hero/hero_overlay_7.png" alt="Hero Image">
            </div>
            <div class="container">
                <div class="hero-style8">
                    <span class="hero-subtitle" data-ani="slideindown" data-ani-delay="0.7s">Empowering Your Future</span>
                    <h1 class="hero-title" data-ani="slideindown" data-ani-delay="0.4s">Smartly Insured</h1>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-xxl-7 col-lg-6 mb-lg-0 mb-40">
                    <div class="about-thumb4">
                        ...
                        <div class="about4-dot shape-mockup jump" data-bottom="-38px" data-left="-36px"><img src="assets/img/shape/dots.png" alt="img"></div>
                    </div>
                </div>
                <div class="col-xxl-5 col-lg-6">
                    ...
                    <p class="mt-n1 mb-30">Phasellus placerat, ante sit amet sodales fermentum, purus lectus aliquam eros, elementum blandit ligula turpis sit amet lorem. Quisque purus ante, malesuada eget arcu et, convallis</p>
...
Service Area  
==============================-->
    <section class="service-sec5 bg-title space-bottom" data-bg-src="assets/img/bg/service-bg-5.png">
        <div class="position-relative space-top">
            <div class="service-sec5-img img-half img-right z-index-step1">
                <img src="assets/img/bg/service-5-left.png" alt="img">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="title-area text-xl-start text-center">
                            <span class="sub-title style3">Our Insurance</span>
                            <h2 class="sec-title text-white">Our Popular Insurance</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-8 position-relative">
                        <div class="row g-0 service-wrap-5">
                            <div class="col-md-6 service-grid style3">
                                <div class="icon">
                                    <img src="assets/img/icon/service_icon_4_1.svg" alt="Icon">
                                </div>
                                <div class="service-grid_content">
                                    <h3 class="service-grid_title h4"><a href="service-details.html">Home Insurance</a></h3>
                                    <p class="service-grid_text">Feugiat. Praesent hendrerit quam non ante vulputate, non vest ibulum velit gravida fusce.</p>
                                    <a href="service-details.html" class="half-line-btn" tabindex="0">Read More</a>
                                </div>
                            </div>
                            <div class="col-md-6 service-grid style3">
                                <div class="icon">
                                    <img src="assets/img/icon/service_icon_4_2.svg" alt="Icon">
                                </div>
                                <div class="service-grid_content">
                                    <h3 class="service-grid_title h4"><a href="service-details.html">Life Insurance</a></h3>
                                    <p class="service-grid_text">Praesent hendrerit quam non ante vulputate, non vestibulum velit gravida. Fusce lobortis orci.</p>
                                    <a href="service-details.html" class="half-line-btn" tabindex="0">Read More</a>
                                </div>
                            </div>
                            <div class="col-md-6 service-grid style3">
                                <div class="icon">
                                    <img src="assets/img/icon/service_icon_4_3.svg" alt="Icon">
                                </div>
                                <div class="service-grid_content">
                                    <h3 class="service-grid_title h4"><a href="service-details.html">Health Insurance</a></h3>
                                    <p class="service-grid_text">Hendrerit praesent quam non ante vulputate, non vestibulum velit gravida. Fusce lobortis orci.</p>
                                    <a href="service-details.html" class="half-line-btn" tabindex="0">Read More</a>
                                </div>
                            </div>
                            <div class="col-md-6 service-grid style3">
                                <div class="icon">
                                    <img src="assets/img/icon/service_icon_4_4.svg" alt="Icon">
                                </div>
                                <div class="service-grid_content">
                                    <h3 class="service-grid_title h4"><a href="service-details.html">Vehicle Insurance</a></h3>
                                    <p class="service-grid_text">Vulputate praesent hendrerit quam non ante, non vestibulum velit gravida. Fusce lobortis.</p>
                                    <a href="service-details.html" class="half-line-btn" tabindex="0">Read More</a>
                                </div>
                            </div>
                        </div>
                        <div class="service-counter">
                            <h3 class="service-counter_title"><span class="counter-number" data-bg-src="assets/img/icon/service_icon_4_5.svg">156</span>k</h3>
                            <h6 class="service-counter_text">Clients<br>Satisfied</h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6">
                    ...
                    <p class="mt-n2 mb-30">Aenean non arcu ut libero molestie aliquet at a neque. Donec dignissim dui ipsum, vitae fermentum mauris gravida vitae.</p>
                    <div class="wcu-skill-wrap" data-bg-src="assets/img/bg/wcu-skill-wrap-bg.png">
                        ...
                        <div class="skill-feature">
                            <h5 class="skill-feature_title">Quality Security</h5>
                            <div class="progress">
                    ...
                    <div class="btn-wrap mt-50">
                        ...
                        <div class="client-group-thumb2">
                            <div class="thumb">
                                <img src="assets/img/normal/testimonial-group-img2.png" alt="img">
                            </div>
                            <div class="counter">
                                <span class="counter-number">359</span>k
        ...
        <div class="cta-sec5 text-lg-start text-center" data-bg-src="assets/img/bg/cta_bg_4.png">
            <div class="row gy-5 justify-content-lg-between justify-content-center align-items-center">
                <div class="col-lg-auto order-lg-2">
                    <a href="tel:+111458586558" class="cta-icon play-btn"><img src="assets/img/icon/cta-icon-1.svg" alt="img"></a>
                </div>
                ...
                <div class="col-lg-auto order-lg-3">
                    <div class="btn-group justify-content-center">
                        <a href="service.html" class="th-btn style3">Contact With Us<i class="far fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="btn-wrap mt-50">
                        <a href="contact.html" class="th-btn style2 mt-0">Read More<i class="far fa-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div class="row justify-content-between">
                <div class="col-xl-5">
                    <div class="title-area space-top mb-0">
                        ...
                        <p class="mt-30">Donec et lobortis quam. Praesent venenatis massa vel ullamcorper auctor. Quisque venenatis ac ipsum eget dapibus.</p>
                ...
                <div class="col-xl-6">
                    <div class="th-carousel testi-slider4" data-slide-show="3" data-arrows="true" data-xl-arrows="true" data-ml-arrows="true" data-vertical="true">
                        <div class="testi-box4">
                            <div class="testi-box_wrap">
                                ...
                                <div class="testi-content">
                                    <p class="testi-box_text">Praesent venenatis massa vel ullamcorper auctor. Quisque venenatis ac ipsum eget dapibus. Curabitur efficitur, massa sit amet </p>
                                    <div class="media">
                        ...
                        <div class="testi-box4">
                            <div class="testi-box_wrap">
                                ...
                                <div class="testi-content">
                                    <p class="testi-box_text">Vestibulum Praesent venenatis massa vel auctor. Quisque ac ipsum eget dapibus. Curabitur efficitur, massa sit amet </p>
                                    <div class="media">
                                        <div class="media-left">
                        ...
                        <div class="testi-box4">
                            <div class="testi-box_wrap">
                                ...
                                <div class="testi-content">
                                    <p class="testi-box_text">Curabitur venenatis massa vel ullamcorper auctor. Quisque venenatis ac ipsum eget dapibus. Praesent efficitur, massa sit amet </p>
                                    <div class="media">
                                        <div class="media-left">
                        ...
                        <div class="testi-box4">
                            <div class="testi-box_wrap">
                                ...
                                <div class="testi-content">
                                    <p class="testi-box_text">Efficitur venenatis massa vel ullamcorper auctor. Quisque venenatis ac ipsum eget dapibus. Curabitur efficitur, massa sit amet</p>
                                    <div class="media">
                                        <div class="media-left">
...
==============================-->
    <div class="overflow-hidden space-top mb-30">
        ...
        <div class="container-fluid p-0">
            <div class="row th-carousel" data-slide-show="4" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-xs-slide-show="1" data-dots="false">
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="project-card style-2">
                        ...
                        <div class="project-content">
                            <a href="assets/img/project/portfolio_3_1.png" class="icon-btn popup-image" tabindex="-1"><i class="fa-light fa-arrow-up-right"></i></a>
                            <h4 class="project-title"><a href="project-details.html">Family Financial Insurance</a></h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="project-card style-2">
                        ...
                        <div class="project-content">
                            <a href="assets/img/project/portfolio_3_2.png" class="icon-btn popup-image" tabindex="-1"><i class="fa-light fa-arrow-up-right"></i></a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="project-card style-2">
                        ...
                        <div class="project-content">
                            <a href="assets/img/project/portfolio_3_3.png" class="icon-btn popup-image" tabindex="-1"><i class="fa-light fa-arrow-up-right"></i></a>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <div class="project-card style-2">
                        ...
                        <div class="project-content">
                            <a href="assets/img/project/portfolio_3_4.png" class="icon-btn popup-image" tabindex="-1"><i class="fa-light fa-arrow-up-right"></i></a>
                            <h4 class="project-title"><a href="project-details.html">Insurance Consult Solution</a></h4>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xl-3">
...
==============================-->
    <section class="brand-sec1" data-bg-src="assets/img/bg/brand-bg1.png">
        ...
        <div class="container">
            <div class="row th-carousel" data-slide-show="5" data-lg-slide-show="4" data-md-slide-show="3" data-sm-slide-show="3" data-xs-slide-show="2">
                <div class="col-auto">
                    <div class="brand-box">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-card_content">
                            ...
                            <h3 class="blog-title border-bottom box-title"><a href="blog-details.html">Insurance is a highly Regulated industry.</a></h3>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-card_content">
                            ...
                            <h3 class="blog-title border-bottom box-title"><a href="blog-details.html">Protecting your assets, Securing your future.</a></h3>
                            <a href="blog-details.html" class="half-line-btn">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="blog-card">
                        ...
                        <div class="blog-card_content">
                            ...
                            <h3 class="blog-title border-bottom box-title"><a href="blog-details.html">Be prepared for anything With our insurance.</a></h3>
                            <a href="blog-details.html" class="half-line-btn">Read More</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-xxl-3 col-xl-3">
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                ...
                                <p class="about-text">Nam dictum, magna eu mattis dictum, nisl augue efficitur justo, vel auctor magna </p>
                                <p class="footer-info">
                                ...
                                <p class="footer-info">
                                    ...
                                    <a href="mailto:info.support@gmail.com" class="info-box_link">info.support@gmail.com</a>
                                </p>
                                <p class="footer-info">
                            ...
                            <div class="recent-post-wrap">
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h4 class="post-title"><a class="text-inherit" href="blog-details.html">Be prepared for anything With our insurance.</a></h4>
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h4 class="post-title"><a class="text-inherit" href="blog-details.html">Trust us to protect what you love most.</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
