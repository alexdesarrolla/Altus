...
<head>
    ...
    <title>Insurax - Insurance Company HTML Template - Pricing Plan</title>
...
Contact Area  
==============================-->
    <div class="bg-title" id="contact-sec" data-bg-src="assets/img/bg/contact-bg.png">
        <div class="container">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-5 ps-xxl-5 align-self-end">
                        <form action="mail.php" method="POST" class="contact-form">
                            <div class="bg-arrow"><img src="assets/img/icon/contact-bg-arrow.svg" alt="img"></div>
        ...
        <div class="row">
            <div class="col-xl-5">
                <div class="client-group-thumb">
                    <div class="thumb">
                        <img src="assets/img/normal/testimonial-group-img.png" alt="img">
                    </div>
                    <div class="counter">
